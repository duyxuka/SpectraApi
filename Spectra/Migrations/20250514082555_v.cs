    ...
    public partial class v : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Spectra_Modules", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Spectra_Roles", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Spectra_Permissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Spectra_Permissions_Spectra_Modules_ModulesId",
                        column: x => x.ModulesId,
                        principalTable: "Spectra_Modules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Spectra_Permissions_Spectra_Roles_RolesId",
                        column: x => x.RolesId,
                        principalTable: "Spectra_Roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "Spectra_UserRoleAdmin",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Spectra_UserRoleAdmin", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Spectra_UserRoleAdmin_Spectra_AccountAdmin_AccountAdminId",
                        column: x => x.AccountAdminId,
                        principalTable: "Spectra_AccountAdmin",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Spectra_UserRoleAdmin_Spectra_Roles_RolesId",
                        column: x => x.RolesId,
                        principalTable: "Spectra_Roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Spectra_UserRoleCustomer", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Spectra_UserRoleCustomer_Spectra_AccountUser_AccountUserId",
                        column: x => x.AccountUserId,
                        principalTable: "Spectra_AccountUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Spectra_UserRoleCustomer_Spectra_Roles_RolesId",
                        column: x => x.RolesId,
                        principalTable: "Spectra_Roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Spectra_ProductVariant", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Spectra_ProductVariant_Spectra_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Spectra_Product",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "Spectra_ProductVariant_Attributes",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ProductVariantId = table.Column<int>(nullable: false),
                    ValueAttributeId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Spectra_ProductVariant_Attributes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Spectra_ProductVariant_Attributes_Spectra_ProductVariant_ProductVariantId",
                        column: x => x.ProductVariantId,
                        principalTable: "Spectra_ProductVariant",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Spectra_ProductVariant_Attributes_Spectra_ValueAttribute_ValueAttributeId",
                        column: x => x.ValueAttributeId,
                        principalTable: "Spectra_ValueAttribute",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Spectra_Permissions_ModulesId",
                table: "Spectra_Permissions",
                column: "ModulesId");

            migrationBuilder.CreateIndex(
                name: "IX_Spectra_Permissions_RolesId",
                table: "Spectra_Permissions",
                column: "RolesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Spectra_ProductVariant_ProductId",
                table: "Spectra_ProductVariant",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_Spectra_ProductVariant_Attributes_ProductVariantId",
                table: "Spectra_ProductVariant_Attributes",
                column: "ProductVariantId");

            migrationBuilder.CreateIndex(
                name: "IX_Spectra_ProductVariant_Attributes_ValueAttributeId",
                table: "Spectra_ProductVariant_Attributes",
                column: "ValueAttributeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Spectra_UserRoleAdmin_AccountAdminId",
                table: "Spectra_UserRoleAdmin",
                column: "AccountAdminId");

            migrationBuilder.CreateIndex(
                name: "IX_Spectra_UserRoleAdmin_RolesId",
                table: "Spectra_UserRoleAdmin",
                column: "RolesId");

            migrationBuilder.CreateIndex(
                name: "IX_Spectra_UserRoleCustomer_AccountUserId",
                table: "Spectra_UserRoleCustomer",
                column: "AccountUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Spectra_UserRoleCustomer_RolesId",
                table: "Spectra_UserRoleCustomer",
                column: "RolesId");
