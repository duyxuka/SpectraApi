    ...
    public partial class v1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Spectra_RolePermissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Spectra_RolePermissions_Spectra_Permissions_PermissionId",
                        column: x => x.PermissionId,
                        principalTable: "Spectra_Permissions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Spectra_RolePermissions_Spectra_Roles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Spectra_UserRoles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Spectra_UserRoles_Spectra_Roles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "Spectra_Roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Spectra_RolePermissions_PermissionId",
                table: "Spectra_RolePermissions",
                column: "PermissionId");

            migrationBuilder.CreateIndex(
                name: "IX_Spectra_RolePermissions_RoleId",
                table: "Spectra_RolePermissions",
                column: "RoleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Spectra_UserRoles_RoleId",
